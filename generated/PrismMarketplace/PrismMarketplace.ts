...
export class PrismMarketplace__getListingResultValue0Struct extends ethereum.Tuple {
  get price(): BigInt {
...
export class PrismMarketplace extends ethereum.SmartContract {
  static bind(address: Address): PrismMarketplace {
    return new PrismMarketplace("PrismMarketplace", address);
  }

  getListing(
    nftAddress: Address,
    tokenId: BigInt
  ): PrismMarketplace__getListingResultValue0Struct {
    ...
    return changetype<PrismMarketplace__getListingResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getListing(
    nftAddress: Address,
    tokenId: BigInt
  ): ethereum.CallResult<PrismMarketplace__getListingResultValue0Struct> {
    ...
    return ethereum.CallResult.fromValue(
      changetype<PrismMarketplace__getListingResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
